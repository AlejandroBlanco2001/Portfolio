...
const Contact = () => {
    ...
    const sendForm = (event: any) => {
        ...
        window.open(`mailto:alex.zgz@live.com?body=${`Hi, my name is ${name} \n message`}`);
    }
            ...
            <div className="contact-container">
                <div className="contact-info">
                    <form className="contact-form">
                        <input onChange={onHandleChange} className="input-form" type="text" name="name" placeholder="Name" />
                        <textarea onChange={onHandleChange} className="input-form" name="message" placeholder="Message" />
                    </form>
                </div>
                <br></br>
                <h3>Also you can follow my work in this social media</h3>
                <div className="social-media">
                    ...
                    <a href="https://www.linkedin.com/in/alejandroblancoamador/">
                ...
                <button onClick={sendForm} type="submit" className="btn">Send</button>
            </div>
        </div>
    );
}
